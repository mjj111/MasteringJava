...
public class StringTest extends AutoTester {
    ...
    public void 숫자만_포함하는_문자열인지_확인(){
        String GIVEN_RIGHT_INPUT = "123123";
        String GIVEN_WRONG_INPUT = "sdk124125";
    ...
    public void 문자열에서_문자_빈도수를_반환(){
        String GIVEN_INPUT = "asdqbaa";
        Map<Character, Long> EXPECTED_OUTPUT = Map.of('a',3L,
                's',1L,
                'd',1L,
                'q',1L,
                'b',1L);
